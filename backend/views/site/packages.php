        ...
        <div class="col-md-12 bg-white p-4" style="max-height: 80vh; overflow-y: auto; scrollbar-color: #5C4033 #FFD700; scrollbar-width: thin;">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="m1-tab" data-bs-toggle="tab" data-bs-target="#m1" type="button" role="tab" aria-controls="monthly" aria-selected="true">Monthly</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="m6-tab" data-bs-toggle="tab" data-bs-target="#m6" type="button" role="tab" aria-controls="6-month" aria-selected="false">6 Month</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="m12-tab" data-bs-toggle="tab" data-bs-target="#m12" type="button" role="tab" aria-controls="annually" aria-selected="false">Annually</button>
                </li>
            </ul>
