...
class ItemController extends Controller {
    ...
    public function actionView(string $id) {
        ...
        $routesOnly = array_filter($model->getItems()['available'], function ($value) {
            return $value === 'route';
        });
        $finalArray = [
            'available' => $routesOnly,
            'assigned' => $model->getItems()['assigned']
        ];
        return $this->render('view', ['model' => $model, 'finalArray' => $finalArray]);
    }
...
//    }
    ...
    public function actionAssign(string $id) {
        ...
        // Filter the array to keep only entries with the value 'route'
        $routesOnly = array_filter($model->getItems()['available'], function ($value) {
            return $value === 'route';
        });
        $finalArray = [
